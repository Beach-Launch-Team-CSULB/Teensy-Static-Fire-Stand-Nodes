...
MCU_SENSOR ChamberPT2{55, 2, A5, 10, 100, 1000, false};             // 3
MCU_SENSOR ChamberPT1{56, 2, A6, 10, 100, 1000, false};             // 4
MCU_SENSOR FuelInletPropSidePT{57, 2, A7, 2, 10, 100, false};       // 5
MCU_SENSOR FuelInjectorPT{58, 2, A8, 10, 100, 1000, false};         // 6
MCU_SENSOR LoxInletPropSidePT{59, 2, A9, 2, 10, 100, false};        // 7
MCU_SENSOR MVPneumaticsPT{78, 3, A3, 2, 10, 100, false};            // 8
MCU_SENSOR DomeRegFuelPT{79, 3, A4, 2, 10, 100, false};             // 9
MCU_SENSOR DomeRegLoxPT{80, 3, A5, 2, 10, 100, false};              // 10
MCU_SENSOR FuelTankPT{81, 3, A6, 2, 10, 100, false};                // 11
MCU_SENSOR LoxTankPT{82, 3, A7, 2, 10, 100, false};                 // 12
MCU_SENSOR HiPressFuelPT{83, 3, A8, 2, 10, 100, false};             // 13
MCU_SENSOR HiPressLoxPT{84, 3, A9, 2, 10, 100, false};              // 14
